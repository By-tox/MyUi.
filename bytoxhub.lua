-- bytoxhub UI Library
-- Modified for: Gray, Silver, White, Black theme
-- Features: Animated White/Silver border, Close button with hide feature
    ...
    function Manager:AddToTab(tab)
        ...
        tab:Button({
            ...
            Callback = function()
                ...
                local gui = core:FindFirstChild("bytoxhub UI")
...
function Library:New(config)
    ...
    self.Main = Create("Frame", {
        ...
        BackgroundColor3 = Color3.fromRGB(25, 25, 25), -- Black/Dark Gray
        BorderSizePixel = 0,
        Parent = self.Gui
    }, {
    ...
    -- Animated Border (White and Silver)
    ...
    task.spawn(function()
        ...
        while self.Main and self.Main.Parent do
            ...
            BorderStroke.Color = Color3.fromRGB(200, 200, 200):Lerp(Color3.fromRGB(255, 255, 255), alpha)
        end
    end)

    self.Top = Create("Frame", {
        Size = UDim2.new(1, 0, 0, 55),
        BackgroundColor3 = Color3.fromRGB(35, 35, 35), -- Dark Gray
        Parent = self.Main
    }, {
        Create("UICorner", {CornerRadius = UDim.new(0, 12)}),
        Create("Frame", {
    ...
    Create("TextLabel", {
        Text = config.Footer or "bytoxhub Interface • v1.0",
        Font = Enum.Font.GothamMedium,
        TextSize = 11,
        TextColor3 = Color3.fromRGB(150, 150, 150), -- Gray
        TextXAlignment = "Left",
        BackgroundTransparency = 1,
    ...
    self.TabHighlight = Create("Frame", {
        ...
        BackgroundColor3 = Color3.fromRGB(200, 200, 200), -- Silver/Gray
        ...
        Create("UIStroke", {Color = Color3.fromRGB(255, 255, 255), Thickness = 1, Transparency = 0.6})
    })
    ...
    function Library:Notify(config)
        ...
        local NotifGui = gethui():FindFirstChild("bytoxhubNotifications")
        if not NotifGui then
            NotifGui = Create("ScreenGui", {
                Name = "bytoxhubNotifications",
                Parent = gethui(),
        ...
        local Notif = Create("Frame", {
            ...
            Create("UICorner", {CornerRadius = UDim.new(0, 8)}),
            Create("UIStroke", {Color = Color3.fromRGB(200, 200, 200), Thickness = 1.2, Transparency = 1})
        })
    ...
    function self:NewTab(name)
        ...
        TabBtn.MouseButton1Click:Connect(function()
            ...
            TweenService:Create(self.TabHighlight, TweenInfo.new(0.3, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {
                Position = UDim2.fromOffset(8, TabBtn.Position.Y.Offset + 8)
            }):Play()
            for _, b in pairs(self.TabHolder:GetChildren()) do
                if b:IsA("TextButton") then
                    TweenService:Create(b, TweenInfo.new(0.2), {TextColor3 = Color3.fromRGB(180, 180, 180)}):Play()
                end
            end
            TweenService:Create(TabBtn, TweenInfo.new(0.2), {TextColor3 = Color3.fromRGB(255, 255, 255)}):Play()
        end)

        if #self.TabHolder:GetChildren() == 3 then -- First tab (ListLayout + Padding + TabBtn)
            task.spawn(function()
                Page.Visible = true
                self.TabHighlight.Visible = true
                self.TabHighlight.Position = UDim2.fromOffset(8, 8)
        ...
        function Tab:Button(config)
            ...
            Btn.MouseButton1Down:Connect(function()
                TweenService:Create(BtnBg, TweenInfo.new(0.1), {BackgroundColor3 = Color3.fromRGB(45, 45, 45)}):Play()
            end)
            Btn.MouseButton1Up:Connect(function()
                TweenService:Create(BtnBg, TweenInfo.new(0.1), {BackgroundColor3 = Color3.fromRGB(35, 35, 35)}):Play()
            end)
        ...
        function Tab:Toggle(config)
            ...
            local Switch = Create("Frame", {
                ...
                BackgroundColor3 = state and Color3.fromRGB(200, 200, 200) or Color3.fromRGB(50, 50, 50),
                Parent = TglBg
            }, {
            ...
            local function updateView(val)
                TweenService:Create(Switch, TweenInfo.new(0.2), {
                    BackgroundColor3 = val and Color3.fromRGB(200, 200, 200) or Color3.fromRGB(50, 50, 50)
                }):Play()
        ...
        function Tab:Slider(config)
            ...
            local Knob = Create("Frame", {
                ...
                Create("UIStroke", {Color = Color3.fromRGB(200, 200, 200), Thickness = 1.5})
            })
        ...
        function Tab:Dropdown(config)
            ...
            local DropHighlight = Create("Frame", {
                ...
                Create("UIStroke", {Color = Color3.fromRGB(255, 255, 255), Thickness = 1, Transparency = 0.5})
            })
            ...
            local function Select(v, btn)
                ...
                for _, o in pairs(OptionHolder:GetChildren()) do
                    if o:IsA("TextButton") then
                        TweenService:Create(o, TweenInfo.new(0.2), {TextColor3 = Color3.fromRGB(180, 180, 180)}):Play()
                    end
                end
        ...
        function Tab:Label(config)
            ...
            local LabelBg = Create("Frame", {
                ...
                Create("UICorner", {CornerRadius = UDim.new(0, 8)}),
                Create("UIStroke", {Color = Color3.fromRGB(60, 60, 60), Thickness = 1, Transparency = 0.5})
            })
        ...
        function Tab:Keybind(config)
            ...
            Hit.MouseButton1Click:Connect(function()
                listening = true
                BindText.Text = "..."
                TweenService:Create(BindDisplay:FindFirstChildOfClass("UIStroke"), TweenInfo.new(0.2), {Color = Color3.fromRGB(255, 255, 255)}):Play()
            end)
            ...
            UIS.InputBegan:Connect(function(input, gpe)
                ...
                if listening and input.UserInputType == Enum.UserInputType.Keyboard then
                    ...
                    TweenService:Create(BindDisplay:FindFirstChildOfClass("UIStroke"), TweenInfo.new(0.2), {Color = Color3.fromRGB(80, 80, 80)}):Play()
                ...
                elseif not listening and input.UserInputType == Enum.UserInputType.Keyboard and input.KeyCode == default then
                    local t = TweenService:Create(BindDisplay, TweenInfo.new(0.1), {BackgroundColor3 = Color3.fromRGB(255, 255, 255)})
                    t:Play()
                    t.Completed:Connect(function()
                        TweenService:Create(BindDisplay, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(45, 45, 45)}):Play()
                    end)
                    callback()
                end
            end)
        ...
        function Tab:Textbox(config)
            ...
            Input.Focused:Connect(function()
                ...
                TweenService:Create(InputHolder:FindFirstChildOfClass("UIStroke"), TweenInfo.new(0.4), {Color = Color3.fromRGB(255, 255, 255)}):Play()
            ...
            Input.FocusLost:Connect(function(enterPressed)
                ...
                TweenService:Create(InputHolder:FindFirstChildOfClass("UIStroke"), TweenInfo.new(0.4), {Color = Color3.fromRGB(70, 70, 70)}):Play()
