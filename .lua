...
Create("UIStroke", {
	Color = Color3.fromRGB(170, 170, 170), -- فضي ناعم
	Thickness = 1.5,
	Transparency = 0.15
})
	...
	BackgroundColor3 = Color3.fromRGB(0, 0, 0), -- أسود
	BorderSizePixel = 0,
	Parent = self.Main
}, {
	-- زوايا ناعمة
	...
	Create("Frame", {
		...
		BackgroundColor3 = Color3.fromRGB(170, 170, 170), -- فضي
		BorderSizePixel = 0,
	})
})
	...
	TextSize = 18,
	TextColor3 = Color3.fromRGB(255, 255, 255), -- خط أبيض
	TextXAlignment = Enum.TextXAlignment.Left,
	BackgroundColor3 = Color3.fromRGB(0, 0, 0), -- خلفية سوداء
	...
	-- حواف فضي
	Create("UIStroke", {
		Color = Color3.fromRGB(170, 170, 170), -- فضي
		Thickness = 1,
		Transparency = 0.15
	})
})
	...
	-- حواف فضي خفيف
	Create("UIStroke", {
		Color = Color3.fromRGB(160, 160, 160), -- فضي أهدى
		Thickness = 1,
		Transparency = 0.3
	})
})
	...
	Font = Enum.Font.GothamBold,
	TextSize = 22,
	TextColor3 = Color3.fromRGB(255, 255, 255), -- أيقونة بيضاء
	BackgroundColor3 = Color3.fromRGB(0, 0, 0), -- خلفية سوداء
	BackgroundTransparency = 0,
	...
	BackgroundColor3 = Color3.fromRGB(0, 0, 0), -- أسود داكن
	ZIndex = 49,
	Parent = ToggleBtn
}, {
	-- زوايا ناعمة
	...
	-- حواف فضي خفيف
	Create("UIStroke", {
		Color = Color3.fromRGB(160, 160, 160), -- فضي ناعم
		Thickness = 1,
...
self.Sidebar = Create("Frame", {
	...
	Create("UIStroke", {Color = Color3.fromRGB(160, 160, 160), Thickness = 1}) -- فضي
})
...
self.TabHighlight = Create("Frame", {
	...
	BackgroundColor3 = Color3.fromRGB(80, 150, 255), -- أزرق هادي
...
local Notif = Create("Frame", {
	...
	Create("UICorner", {CornerRadius = UDim.new(0, 8)}),
	Create("UIStroke", {Color = Color3.fromRGB(160, 160, 160), Thickness = 1.2, Transparency = 0.2}) -- فضي
})
...
local TitleLabel = Create("TextLabel", {
	...
	Font = Enum.Font.GothamBold,
	TextSize = 12,
	TextColor3 = Color3.fromRGB(80, 150, 255), -- أزرق هادي
	BackgroundTransparency = 1,
	TextTransparency = 0,
...
local Divider = Create("Frame", {
	...
	BackgroundColor3 = Color3.fromRGB(160, 160, 160), -- فضي خفيف
	BorderSizePixel = 0,
	Parent = Notif
})
...
local ContentLabel = Create("TextLabel", {
	...
	Font = Enum.Font.GothamMedium,
	TextSize = 12,
	TextColor3 = Color3.fromRGB(220, 220, 220), -- أبيض ناعم
	BackgroundColor3 = Color3.fromRGB(0,0,0), -- أسود خلفية
	BackgroundTransparency = 0,
	TextTransparency = 1,
	...
	Create("UIStroke", {Color = Color3.fromRGB(160, 160, 160), Thickness = 1, Transparency = 0.3}) -- فضي خفيف
})
...
local TabBtn = Create("TextButton", {
	...
	Font = Enum.Font.GothamMedium,
	TextSize = 13,
	TextColor3 = Color3.fromRGB(180,180,180), -- رمادي فاتح
	BackgroundTransparency = 1,
	Size = UDim2.fromScale(1,1),
	Parent = TabBg
})
...
function Tab:Dropdown(config)
	...
	local DropdownBg = Create("Frame", {
		...
		Create("UICorner", {CornerRadius = UDim.new(0, 8)}),
		Create("UIStroke", {Color = Color3.fromRGB(160, 160, 160), Thickness = 1}) -- فضي خفيف
	})
        end
